...
class RepRapProtocolTest(unittest.TestCase):
    def setUp(self):
        ...
        self.protocol = octoprint.comm.protocol.reprap.ReprapGcodeProtocol(
    ...
    def testHandshakeWithTemperatureAutoreport(self):
        ...
        self.protocol.connect(self.transport)
        self._perform_and_test_handshake(capabilities={"AUTOREPORT_TEMP": True})
        self.transport.expect_and_send("M155 S2\n", "ok\n")

    def testHandshakeWithTemperatureAutoreportButDisabled(self):
        self.protocol._capability_support[
            octoprint.comm.protocol.reprap.CAPABILITY_AUTOREPORT_TEMP
        ] = False
    ...
    def testHandshakeWithSdAutoreport(self):
        ...
        self.protocol.connect(self.transport)
        self._perform_and_test_handshake(capabilities={"AUTOREPORT_SD_STATUS": True})
    ...
    def _perform_and_test_handshake(self, firmware_name=None, capabilities=None):
        ...
        self.transport.expect_and_send(
            "N2 M105*37\n", "ok T:21.3/0\n"
        )  # temperature query
