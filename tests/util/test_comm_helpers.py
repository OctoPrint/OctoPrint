...
class TestCommHelpers(unittest.TestCase):
    ...
    @data(
        ...
        (
            ...
            0,
            dict(T0=(23.0, 220.0), T1=(50.2, 210.0), T2=(39.4, 220.0), B=(60.0, None)),
            2,
        ),
        (
    ...
    @data(
        ...
        (
            dict(T=(23.0, None), T0=(23.0, None), T1=(42.0, None)),
            0,
            dict(T0=(23.0, None), T1=(42.0, None)),
        ),
        (
            dict(T=(42.0, None), T0=(23.0, None), T1=(42.0, None)),
            1,
            dict(T0=(23.0, None), T1=(42.0, None)),
        ),
        (
            dict(T=(21.0, None), T0=(23.0, None), T1=(42.0, None)),
            0,
            dict(T0=(23.0, None), T1=(42.0, None)),
        ),
        (
            dict(T=(41.0, None), T0=(23.0, None), T1=(42.0, None)),
            1,
            dict(T0=(23.0, None), T1=(42.0, None)),
        ),
        # T and no T0 => Smoothieware, T = T0
        (
            dict(T=(23.0, None), T1=(42.0, None)),
            1,
            dict(T0=(23.0, None), T1=(42.0, None)),
        ),
        # no T => as-is
    ...
    @data(
        (
            ...
            dict(
                KEY1="Value 1", KEY2="Value 2", FIRMWARE_NAME="Some Firmware With Spaces"
            ),
        ),
        (
    ...
    @data(
        ...
        (
            ...
            dict(x=62.417, y=64.781, z=0.2, e=2.72328),
        ),
        (
        ...
        (
            ...
            dict(x=96.99, y=88.31, z=0.3, e0=0.0, e1=0.0, e2=0.0, e3=0.0, e4=0.0, e5=0.0),
        ),
        # whitespace after the :, e.g. AlfaWise U20, see #2839
        ("X:150.0 Y:150.0 Z:  0.7 E:  0.0", dict(x=150.0, y=150.0, z=0.7, e=0.0)),
        # invalid
        ("", None),
