...
you already have Python 3.10+, pip and virtualenv and their dependencies set up on your system:
...
OctoPrint currently supports Python 3.10, 3.11, 3.12, 3.13 and 3.14.
