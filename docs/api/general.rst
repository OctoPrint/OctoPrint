...
key can be either a user specific one or an app and user specific one as generated by the
...
fallback on directing the user to manually supply the the user specific API key.
