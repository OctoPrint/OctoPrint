...
class Server(object):
	...
	def run(self):
		...
		server_routes = self._router.urls + [
			...
			# favicon
			(r"/favicon.ico", util.tornado.StaticDataHandler, dict(data=bytes(base64.b64decode("")),
