...
def getSettings():
	...
	data = {
		...
		"webcam": {
			...
			"rotationOptions": ["rotate0","rotate90","rotate180","rotate270"],
			"rotation": s.get(["webcam", "rotation"])
		},
		"feature": {
...
def setSettings():
	...
	if "webcam" in data.keys():
		...
		if "rotation" in data["webcam"].keys(): s.set(["webcam", "rotation"], data["webcam"]["rotation"])
