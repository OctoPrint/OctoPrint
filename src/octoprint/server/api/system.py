...
def _get_core_command_specs():
	...
	commands = collections.OrderedDict(
		shutdown={"command": s().get(["server", "commands", "systemShutdownCommand"]),
		...
		reboot={"command": s().get(["server", "commands", "systemRestartCommand"]),
		...
		restart={"command": s().get(["server", "commands", "serverRestartCommand"]),
		...
		restart_safe={"command": s().get(["server", "commands", "serverRestartCommand"]),
