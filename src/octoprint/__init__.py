    ...
    if default_config is None:
        ...
        default_config = {
            ...
            "formatters": {
                ...
                "communication": {"format": "%(asctime)s - %(name)s - %(message)s"},
                "commdebug": {"format": "%(asctime)s - %(threadName)s - %(message)s"},
            },
            "handlers": {
                "console": {
                ...
                "connectionFile": {
                    ...
                    "backupCount": 3,
                    "filename": os.path.join(
                        settings.getBaseFolder("logs"), "connection.log"
                    ),
                    "delay": True,
                },
                "commDebugFile": {
                    ...
                    "backupCount": 3,
                    "filename": os.path.join(
                        settings.getBaseFolder("logs"), "commdebug.log"
                    ),
                    "delay": True,
                },
                "pluginTimingsFile": {
